...
from .views import (
    ...
    AdminFinancialRechargeApproveView, AdminFinancialRechargeReceiptView,
    AdminFinancialRechargeRejectView, AdminFinancialRechargeRequestDetailView,
    AdminFinancialRechargeRequestListView, AdminFinancialUserWalletView,
    AdminFinancialWithdrawalListView,
...
urlpatterns = [
    ...
    path('financial/recharge-requests/', AdminFinancialRechargeRequestListView.as_view(), name='admin_financial_recharge_requests'),
    path('financial/recharge-requests/<uuid:id>/', AdminFinancialRechargeRequestDetailView.as_view(), name='admin_financial_recharge_request_detail'),
    path('financial/recharge-requests/<uuid:id>/receipt/', AdminFinancialRechargeReceiptView.as_view(), name='admin_financial_recharge_request_receipt'),
    path('financial/recharge-requests/<uuid:id>/approve/', AdminFinancialRechargeApproveView.as_view(), name='admin_financial_recharge_request_approve'),
    path('financial/recharge-requests/<uuid:id>/reject/', AdminFinancialRechargeRejectView.as_view(), name='admin_financial_recharge_request_reject'),
