...
from .views import (
    ...
    AdminTechnicianDetailView, AdminTechnicianDocumentView,
    AdminTechnicianApproveView, AdminTechnicianRejectView,
    ...
    AdminFinancialAuditListView, AdminFinancialEscrowListView,
    AdminFinancialLedgerListView, AdminFinancialOverviewView,
    AdminFinancialPaymentListView, AdminFinancialRefundListView,
    AdminFinancialUserWalletView, AdminFinancialWithdrawalListView,
...
urlpatterns = [
    ...
    path('technicians/<uuid:id>/documents/<str:document_id>/', AdminTechnicianDocumentView.as_view(), name='admin_technician_document'),
    ...
    # Finance
    path('financial/overview/', AdminFinancialOverviewView.as_view(), name='admin_financial_overview'),
    path('financial/payments/', AdminFinancialPaymentListView.as_view(), name='admin_financial_payments'),
    path('financial/refunds/', AdminFinancialRefundListView.as_view(), name='admin_financial_refunds'),
    path('financial/withdrawals/', AdminFinancialWithdrawalListView.as_view(), name='admin_financial_withdrawals'),
    path('financial/ledger/', AdminFinancialLedgerListView.as_view(), name='admin_financial_ledger'),
    path('financial/escrow/', AdminFinancialEscrowListView.as_view(), name='admin_financial_escrow'),
    path('financial/audit/', AdminFinancialAuditListView.as_view(), name='admin_financial_audit'),
    path('financial/users/<uuid:user_id>/wallet/', AdminFinancialUserWalletView.as_view(), name='admin_financial_user_wallet'),
